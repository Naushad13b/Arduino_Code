// plx-dqa for data storage, PLX-DAQ is a Parallax microcontroller data acquisition add-on tool for Microsoft Excel .
//Utrasonic_sensor HC-SR04
// all are global variable
int trigPin=13; //Utrasonic_sensor HC-SR04 Trip pin connected to Arduino pin 13
...
pinMode(echoPin, INPUT);
 ...
 Serial.println("LABEL,current time,Distance in cm");//label for plx-dqa ms-excel
}
void loop()
{
